...
export const SKILLS: SkillConfig[] = [
  ...
  },
  {
    name: "Alchemy",
    emoji: "⚗️",
    roles: ["Alchemy 10-20", "Alchemy 21-30", "Alchemy 31-40"],
  },
  {
    name: "Armorsmithing",
    emoji: "🛡️",
  ...
  },
  {
    name: "Baking",
    emoji: "🥖",
    roles: ["Baking 10-20", "Baking 21-30", "Baking 31-40"],
  },
  {
    name: "Blacksmithing",
    emoji: "⚒️",
  ...
  },
  {
    name: "Butchering",
    emoji: "🔪",
    roles: ["Butchering 10-20", "Butchering 21-30", "Butchering 31-40"],
  },
  {
    name: "Carpentry",
    emoji: "🪵",
    roles: ["Carpentry 10-20", "Carpentry 21-30", "Carpentry 31-40"],
  },
  {
    name: "Cooking",
    emoji: "🍳",
    roles: ["Cooking 10-20", "Cooking 21-30", "Cooking 31-40"],
  },
  {
    name: "Fletching",
    emoji: "🏹",
    roles: ["Fletching 10-20", "Fletching 21-30", "Fletching 31-40"],
  },
  {
    name: "Jewelrymaking",
    emoji: "💎",
  ...
  },
  {
    ...
    emoji: "🐄",
    roles: [
      "Leatherworking 10-20",
      "Leatherworking 21-30",
  ...
  },
  {
    name: "Mining",
    emoji: "⛏️",
    roles: ["Mining 10-20", "Mining 21-30", "Mining 31-40"],
  },
  {
    name: "Skinning",
    emoji: "🦌",
    roles: ["Skinning 10-20", "Skinning 21-30", "Skinning 31-40"],
  },
  {
    name: "Tailoring",
    emoji: "🧵",
    roles: ["Tailoring 10-20", "Tailoring 21-30", "Tailoring 31-40"],
  },
  {
    name: "Weaponsmithing",
    emoji: "🗡️",
    roles: [
      "Weaponsmithing 10-20",
      "Weaponsmithing 21-30",
      "Weaponsmithing 31-40",
    ],
  },
  {
    name: "Winemaking and Brewing",
    emoji: "🍷",
    roles: [
      "Winemaking and Brewing 10-20",
      "Winemaking and Brewing 21-30",
      "Winemaking and Brewing 31-40",
    ],
  },
  {
    name: "Woodcutting",
    emoji: "🪓",
    roles: ["Woodcutting 10-20", "Woodcutting 21-30", "Woodcutting 31-40"],
  },
];
